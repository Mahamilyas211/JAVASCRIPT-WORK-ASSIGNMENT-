                 /* These question are from 35-38 Function practice docx. */ 
...
// Q(1) Create a block of code that you can use several times.
  ...
  while (true) {
    ...
    var continueCalculation = confirm("Do you want to calculate another factorial?");
...
// Q(3) Write a function that takes first &amp; last name and then it greets the user using his/her full name.
...
// Q(4) Write a function that adds two numbers (input by user) and returns the sum of two numbers.
  ...
  /* Q(5) Calculator:Write a function that takes three arguments num1, num2 & operator & compute the desired operation. Return and show the desired result in your browser.*/
...
// Q(8) Write a function that take start and end number as inputs & display counting in your browser.
  ...
  /* Q(9) Write a nested function that computes hypotenuse of a right
   angle triangle.
  ...
  // Q(11) Write a function that accepts any number of arguments & find largest of the number.
...
/* Q(14) Write a function that takes numbers array, sums its elements
& returns the sum. */
  ...
  /* Q(15) Execute & monitor the output of following JS program:
...
// Q(16) Write a function that computes power of a number. E.g. 2 3 is 8.
  ...
  // Q(17) Write a function that simulates a dice &amp; returns a random dice value.
...
/* Q(19) Write a JavaScript function that checks whether a passed
...
/* Q(20) Write a JavaScript function that accepts a string as a
...
/* Q(21) Write a JavaScript function that accepts a string as a
...
EXPECTED OUTPUT : 'Development' */
 ...
 /* Q(22) Write a JavaScript function that accepts a string as a
...
EXPECTED OUTPUT : 5 */
 ...
 /* Q(24) Write a JavaScript function to extract unique characters
from a string.
EXAMPLE STRING :
...
is NN.' */
 ...
 function calcCircumference(radius) {
  ...
  /* Q(29) The Temperature Converter
